<%@ Page Title="" Language="C#" MasterPageFile="~/ClientMasterPage.master" AutoEventWireup="true" CodeFile="ClientSettings.aspx.cs" Inherits="Client_ClientSettings" %>
     ...
     <table class="auto-style1">
        <tr>
            ...
            <td style="color: #FF0000" class="auto-style3">
                 ...
                 &nbsp;<asp:TextBox ID="TxtOldPwd" runat="server" AutoComplete="off" MaxLength="7"  OnTextChanged="TxtPassportNo_TextChanged" TextMode="Password"></asp:TextBox>
