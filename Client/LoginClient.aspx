<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LoginClient.aspx.cs" Inherits="Client_LoginClient" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style5">Debit Card Number</td>
            <td class="auto-style6">
                <asp:TextBox ID="TxtDebitCard" runat="server" onkeypress="return isNumberKey(event)"  AutoComplete="off"  MaxLength="7"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="auto-style8">
                <asp:HyperLink ID="hlink" runat="server" ForeColor="#0000CC" NavigateUrl="~/Client/forgetpassword.aspx">Forget Password</asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td class="auto-style2">&nbsp;</td>
