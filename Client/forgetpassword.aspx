<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="forgetpassword.aspx.cs" Inherits="Client_forgetpassword" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <table class="auto-style1">
        <tr>
            <td style="color: #FF0000; font-size: xx-large; font-weight: bold">Forget Password</td>
        </tr>
        </table>
    <hr />
    <p>
    ...
    <table class="auto-style1" width =" 100%">
        ...
        <tr>
            <td class="auto-style3">Debit Card Number</td>
