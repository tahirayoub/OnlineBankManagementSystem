   ...
   SqlConnection cn = new SqlConnection(ConfigurationManager.ConnectionStrings["bankDBConnectionString1"].ConnectionString);
    ...
    void ClientBillList()
    {
        ...
        try
        {
            ...
            da = new SqlDataAdapter("Select Client_Bill_Id AS [Select],Transit_Id AS [Transit Id] ,Account_Number AS [Account Number], Name  from ClientBill where Client_Id = '" + fn + "'", cn);
            ds = new DataSet();
