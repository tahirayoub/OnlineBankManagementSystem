<%@ Page Title="" Language="C#" MasterPageFile="~/AdminView.master" AutoEventWireup="true" CodeFile="AdminForgetPassword.aspx.cs" Inherits="Admin_AdminForgetPassword" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <table class="auto-style1">
        <tr>
            <td style="color: #FF0000; font-size: xx-large; font-weight: bold">Admin Forget Password</td>
        </tr>
        </table>
    <hr />
    <p>
    ...
    <table class="auto-style1" width =" 100%">
        ...
        <tr>
            <td class="auto-style3">Enter Admin UserName</td>
