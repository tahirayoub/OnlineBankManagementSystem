<%@ Page Title="" Language="C#" MasterPageFile="~/AdminView.master" AutoEventWireup="true" CodeFile="AdminLogin.aspx.cs" Inherits="Admin_AdminLogin" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    ...
    <table class="auto-style1">
        <tr>
            <td style="color: #FF0000; font-size: xx-large; font-weight: bold">Admin Please LogIn</td>
        </tr>
        </table>
    <hr />
    <p>
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style5">Admin UserName</td>
        ...
        <tr>
            ...
            <td class="auto-style8">
                <asp:HyperLink ID="hlink" runat="server" ForeColor="#0000CC" NavigateUrl="~/Admin/AdminForgetPassword.aspx">Forget Password</asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td class="auto-style2">&nbsp;</td>
