...
public partial class Admin_AdminForgetPassword : System.Web.UI.Page
{
    ...
    protected void BtnSubmit_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            if (TxtUserName.Text != "")
            {
                ...
                string sql = "SELECT  Admin_Id, UserName as un, Email from Admin where UserName = @un";
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = cn;
                ...
                if (dc == TxtUserName.Text)
                {
                    ...
                    LblError.Text = "Admin User Name is Valid";
                    lbleml.Text = eml;
                    checkquestion();
                ...
                else
                {
                    ...
                    LblError.Visible = true;
                    LblError.Text = "Please enter Valid Admin User Name";
                    Session["ccdd"] = null;
    ...
    void checkquestion()
    {
        try
        {
            ...
            if (TxtUserName.Text != "")
            {
                ...
                string sql = "SELECT SQ1, Answer1,SQ2, Answer2,SQ3, Answer3 from Admin where Admin_Id=@sid ";
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = cn;
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = sql;
    ...
    protected void BtnCheckAnswer_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            if (TxtA1.Text != "" && TxtA2.Text != "" && TxtA3.Text != "")
            {
                ...
                string sql = "Select Answer1 ,Answer2 , Answer3  from Admin where Admin_Id=@sid and Answer1=@Answer1 and Answer2=@Answer2 and Answer3=@Answer3";
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = cn;
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = sql;
