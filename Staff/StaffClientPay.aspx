<%@ Page Title="" Language="C#" MasterPageFile="~/StaffMenu.master" AutoEventWireup="true" CodeFile="StaffClientPay.aspx.cs" Inherits="Client_Pay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style3">Pay Bill</td>
            <td style="text-align: right">
        ...
        <tr>
            <td class="auto-style3">Transit Id</td>
            <td>
