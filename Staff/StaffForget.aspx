<%@ Page Title="" Language="C#" MasterPageFile="~/StaffView.master" AutoEventWireup="true" CodeFile="StaffForget.aspx.cs" Inherits="Staff_StaffForget" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <table class="auto-style1">
        <tr>
            <td style="color: #FF0000; font-size: xx-large; font-weight: bold">Staff Forget Password</td>
        </tr>
        </table>
    <hr />
    <p>
    ...
    <table class="auto-style1" width =" 100%">
        ...
        <tr>
            <td class="auto-style3">Enter Staff UserName</td>
