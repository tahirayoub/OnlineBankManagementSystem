<%@ Page Title="" Language="C#" MasterPageFile="~/StaffView.master" AutoEventWireup="true" CodeFile="Staff_Login.aspx.cs" Inherits="Staff_Staff_Login" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    ...
    <table class="auto-style1">
        <tr>
            <td style="color: #FF0000; font-size: xx-large; font-weight: bold">Staff Please LogIn</td>
        </tr>
        </table>
    <hr />
    <p>
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style5">Staff UserName</td>
        ...
        <tr>
            ...
            <td class="auto-style8">
                <asp:HyperLink ID="hlink" runat="server" ForeColor="#0000CC" NavigateUrl="~/Staff/StaffForget.aspx">Forget Password</asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td class="auto-style2">&nbsp;</td>
