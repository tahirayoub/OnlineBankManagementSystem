<%@ Page Title="" Language="C#" MasterPageFile="~/StaffMenu.master" AutoEventWireup="true" CodeFile="StaffMyrecipient.aspx.cs" Inherits="Client_Myrecipient" %>
        ...
        <ContentTemplate>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TxtName" runat="server" height="31px" AutoComplete ="off" width="365px" MaxLength="150"></asp:TextBox>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TxtEmail" runat="server" AutoComplete ="off" Height="31px" Width="175px" TextMode="Email"></asp:TextBox>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
