<%@ Page Title="" Language="C#" MasterPageFile="~/StaffMenu.master" AutoEventWireup="true" CodeFile="StaffClientSettings.aspx.cs" Inherits="Client_ClientSettings" %>

<%@ MasterType VirtualPath="~/StaffMenu.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <table class="auto-style1">
        <tr>
            <td style="color: #FF0000; font-size: medium;">Please Update Below Client Profile Information</td>
        </tr>
        <tr>
            <td>
                <hr />
     ...
     <table class="auto-style1">
         ...
         <tr>
             <td class="auto-style3" style="color: #808000">Passport No</td>
             <td class="auto-style3" style="color: #FF0000">
                 <asp:TextBox ID="TxtPassportNo" runat="server" AutoComplete="off" Enabled="False" EnableViewState="False" MaxLength="7" onkeypress="return isNumberKey(event)" OnTextChanged="TxtPassportNo_TextChanged"></asp:TextBox>
                 &nbsp;</td>
         </tr>
        <tr>
    ...
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td style="color: #808000">
                ...
                <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Icon Images/Update.jpg" OnClick="ImageButton1_Click" />
            </td>
        </tr>
    </table>
