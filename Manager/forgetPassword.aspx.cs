...
public partial class Manager_forgetPassword : System.Web.UI.Page
{
    ...
    protected void BtnSubmit_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            if (TxtUserName.Text != "")
            {
                ...
                string sql = "SELECT  Manager_Id, UserName as un, Email from Manager where UserName = @un";
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = cn;
                ...
                if (dc == TxtUserName.Text)
                {
                    ...
                    LblError.Text = "Manager User Name is Valid";
                    lbleml.Text = eml;
                    checkquestion();
                ...
                else
                {
                    ...
                    LblError.Visible = true;
                    LblError.Text = "Please enter Valid Manager User Name";
                    Session["ccdd"] = null;
    ...
    void checkquestion()
    {
        try
        {
            ...
            if (TxtUserName.Text != "")
            {
                ...
                string sql = "SELECT SQ1, Answer1,SQ2, Answer2,SQ3, Answer3 from Manager where Manager_Id=@sid ";
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = cn;
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = sql;
    ...
    protected void BtnUpdate_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            if (TxtPassword.Text != "" && TxtUserName.Text != "")
            {
                ...
                string sql2 = "UPDATE Manager SET Password=@pwd where Manager_Id=@cid";
                ...
                try
                {
                    ...
                    string bd = "Manager User Name :" + TxtUserName.Text + " and Password is :" + pswd;
                    ...
                    Response.Redirect("~/Manager/ManagerLogin.aspx", false);
