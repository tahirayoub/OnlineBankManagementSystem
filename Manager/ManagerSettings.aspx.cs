...
public partial class Manager_ManagerSettings : System.Web.UI.Page
{
    ...
    void getManagerinfo()
    {
        try
        {
          //  abc = EncryptPasswrod(TxtPassword.Text); 
            cn.Open();
            string sql = "Select First_Name, Last_Name, Occupation, Designation, Monthly_Salary,Email, Address, Country, City, PostalCode, Phone_Number, Password, SQ1, Answer1, SQ2, Answer2, SQ3, Answer3 from Manager where Manager_Id=@m_id";
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = cn;
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            cn.Open();
            string sql = "UPDATE Manager SET First_Name=@First_Name, Last_Name=@Last_Name, Occupation=@Occupation, Designation=@Designation, Monthly_Salary=@Monthly_Salary,Email=@Email, Address=@Address, Country=@Country, City=@City, PostalCode=@PostalCode, Phone_Number=@Phone_Number, Password=@Password, SQ1=@SQ1, Answer1=@Answer1, SQ2=@SQ2, Answer2=@Answer2, SQ3=@SQ3, Answer3=@Answer3 where Manager_Id=@Mid";
