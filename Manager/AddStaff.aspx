<%@ Page Title="" Language="C#" MasterPageFile="~/ManagerMenu.master" AutoEventWireup="true" CodeFile="AddStaff.aspx.cs" Inherits="Admin_AddManager" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table class="auto-style1">
                <tr>
                    <td>
                        <asp:Label ID="Label1" runat="server" ForeColor="Red" Text="Manager : Please Enter Information For New Staff"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
