...
public partial class Manager_ManagerStaffUpdate : System.Web.UI.Page
{
    ...
    protected void GVClientBillList_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            Session["manager_staff_sd"] = row.Cells[1].Text;
            Response.Redirect("~/Manager/ManagerStaffUpdate2.aspx");
        }
        catch
        { }
    }
